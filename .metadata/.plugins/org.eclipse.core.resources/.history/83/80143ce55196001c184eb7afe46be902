...
public class Employee1 {
	...
	void readEmployeeDetails() throws ParseException {
		...
		void displayEmployeeDetails(){
			...
			System.out.println("Student dob = " + employeedob.getDate()+"/"+employeedob.getMonth()+"/"+employeedob.getYear());

			System.out.println("Student dob = " + employeedoj.getDate()+"/"+employeedoj.getMonth()+"/"+employeedoj.getYear());
		}
